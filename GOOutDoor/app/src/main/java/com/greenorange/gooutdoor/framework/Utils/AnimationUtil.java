...
public class AnimationUtil {
	private static int mOrderIndex = 0;
	private static int mDelay = 100;
	private static int mDuration = 300;

	public static void startAnimation(View root, AnimationType type) {
		ViewUtils.init(root.getContext());
		bindAnimation(root, 0, type);
	}

	public static void bindAnimation(View view, int depth, AnimationType type) {
	...
	public static void runAnimation(View view, long delay, AnimationType type) {
		switch (type) {
		case ROTATE:
	...
	public static void runHorizonLeftAnimation(View view, long delay) {
		view.setAlpha(0);
      ...
      public static void runHorizonRightAnimation(View view, long delay) {
		view.setAlpha(0);
		ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(view,
				"translationX", ViewUtils.getScreenWidth(), 0);
		objectAnimator.setInterpolator(new LinearInterpolator());
      ...
      public static void runAlphaAnimation(View view, long delay) {
		view.setAlpha(0);
      ...
      public static void runRotateAnimation(View view, long delay) {
		view.setAlpha(0);
		AnimatorSet set = new AnimatorSet();
		ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(view,
				"rotation", 0f, 360f);
      ...
      public static void runScaleAnimation(View view, long delay) {
		view.setAlpha(0);
		AnimatorSet set = new AnimatorSet();
      ...
      public static void runFlipVertialAnimation(View view, long delay) {
		view.setAlpha(0);
		AnimatorSet set = new AnimatorSet();
      ...
      public static void runFlipHorizonAnimation(View view, long delay) {
		view.setAlpha(0);
		AnimatorSet set = new AnimatorSet();
		ObjectAnimator objectAnimator1 = ObjectAnimator.ofFloat(view,
				"rotationY", -180f, 0f);
