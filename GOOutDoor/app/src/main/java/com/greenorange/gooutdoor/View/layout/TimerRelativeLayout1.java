 ...
 */
public class TimerRelativeLayout1 extends RelativeLayout implements View.OnClickListener {
    ...
    public TimerRelativeLayout1(Context context) {
        this(context, null);
    }
    public TimerRelativeLayout1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public TimerRelativeLayout1(Context context, AttributeSet attrs, int defStyleAttr) {
