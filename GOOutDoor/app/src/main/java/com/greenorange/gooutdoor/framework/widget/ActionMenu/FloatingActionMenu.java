...
import com.greenorange.gooutdoor.framework.widget.ActionMenu.animation.MenuAnimationHandler;
import com.greenorange.outdoorhelper.R;
import com.greenorange.gooutdoor.framework.widget.ActionMenu.animation.DefaultAnimationHandler;
...
public class FloatingActionMenu {
    ...
    public class ActionViewClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            //add by Jas for custom define
            if(customClickListener != null){
                if(customClickListener.onCustomClickListenerClick(v)){
                    return;
                }
            }
            if(!isAnimating()) {
     ...
     * add by Jas
     */
    public interface ActionViewCustomClickListener{
        public boolean onCustomClickListenerClick(View v);
    }
    private ActionViewCustomClickListener customClickListener;

    public void setCustomClickListener(ActionViewCustomClickListener customClickListener) {
        this.customClickListener = customClickListener;
    }
    public boolean isAnimating(){
        return (animationHandler != null && animationHandler.isAnimating());
    }
    /**
     * end add by Jas
     */
