...
public class Utils {
    ...
    public static String getMBFromSize(Context context, long size){
        return context.getString(R.string.size_m, (float)size/1024/1024.0);
    }
    public static String getPreSize(Context context, long size){
        return context.getString(R.string.pre, size);
    }
}
