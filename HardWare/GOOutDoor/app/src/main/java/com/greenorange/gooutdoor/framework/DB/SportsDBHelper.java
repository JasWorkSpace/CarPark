...
public class SportsDBHelper {
    ...
    public static List<SportsDBData> getSuccessSportsLimitDataByUserId(Context context, String userId, int start, int limit){
        Cursor cursor = null;
        try{
            cursor = context.getContentResolver().query(
                    ScheduleContract.Sports.CONTENT_URI, SportsQuery.PROJECTION,
                    ...
                    ScheduleContract.Sports._ID + " desc limit " + start +"," + limit
            );
