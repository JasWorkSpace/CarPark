...
public class SportsDataSaveAsyncTask extends ShareExt {
    ...
    protected String doInBackground(Object... params) {
        ...
        }catch (Throwable e){Log.d("SportsDataSaveAsyncTask doInBackground fail !!!");}
        return null;
    }
    ...
    private boolean saveDB(UserSportsData userSportsData){
        if(userSportsData != null){
            ...
            ((ApplicationDao) GOApplication.getDaoManager().getManager(Dao.ApplicationDao)).updateUser();
            Log.d("****************************");
            //add sports
